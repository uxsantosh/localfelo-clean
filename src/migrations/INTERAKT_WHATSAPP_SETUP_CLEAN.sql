-- =====================================================
-- Interakt WhatsApp Notification System - Clean Migration
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_notifications_template ON whatsapp_notifications(template_name);
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_notifications_user_template_sent 
  ON whatsapp_notifications(user_id, template_name, sent_at DESC);
...
CREATE POLICY "Service role can update whatsapp notifications"
  ON whatsapp_notifications
  FOR UPDATE
  TO service_role
  USING (true);
...
--   '919876543210',
--   'task_accepted',
--   '{"customer_name": "Test User", "helper_name": "Test Helper", "task_title": "Test Task", "task_price": "₹500"}'::jsonb,
--   NULL
-- );
