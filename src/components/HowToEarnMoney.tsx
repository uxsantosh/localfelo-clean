...
import { ArrowRight, ToggleRight, MapPin, Bell, UserCheck, Check, Coins, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function HowToEarnMoney() {
  ...
  const steps = [
    {
      title: "Enable Available To Earn",
      text: "Start receiving opportunities",
      icon: ToggleRight,
      accentGlow: "rgba(240, 50, 32, 0.18)"
    },
    {
      title: "Choose Categories",
      text: "Select what you can help with",
      icon: MapPin,
      accentGlow: "rgba(240, 50, 32, 0.18)"
    },
    {
      title: "Receive Task Alerts",
      text: "Relevant nearby tasks",
      icon: Bell,
      accentGlow: "rgba(240, 50, 32, 0.18)"
    },
    {
      title: "Show Interest",
      text: "Tap I'm Interested",
      icon: Check,
      accentGlow: "rgba(240, 50, 32, 0.18)"
    },
    {
      title: "Get Selected",
      text: "Connect with task owner",
      icon: UserCheck,
      accentGlow: "rgba(240, 50, 32, 0.18)"
    },
    {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-[radial-gradient(circle,rgba(240,50,32,0.03)_0%,transparent_75%)] blur-[120px] pointer-events-none z-0" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto mb-8 md:mb-16">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#F03220]/10 border border-[#F03220]/20 mb-2">
            <span className="text-[10px] font-bold text-[#F03220] uppercase tracking-widest">Helper Flow</span>
          </div>
          <h2 className="text-3xl sm:text-5xl font-black text-white tracking-tight font-sans">
            How To <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-neutral-100 to-[#F03220]">Earn Money</span>
          </h2>
          <p className="text-neutral-400 text-sm sm:text-base font-normal tracking-wide font-sans max-w-lg mx-auto">
            Help nearby people and get paid. Turn your free time into earnings.
          </p>
        </div>
          ...
          {steps.map((st, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Info block */}
                <div className="px-1 text-center space-y-1 block">
                  ...
                  <p className="text-xs text-neutral-500 font-medium group-hover:text-neutral-400 transition-colors duration-300 select-none">
                    {st.text}
                  </p>
                </div>
