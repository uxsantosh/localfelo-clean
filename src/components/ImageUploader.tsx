...
export function ImageUploader({ images, onImagesChange, maxImages = 6 }: ImageUploaderProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      {processing && (
        <div className="bg-[#CDFF00] border-2 border-gray-200 p-3 rounded-lg flex items-center gap-3">
      ...
      {/* Error Message */}
      {error && (
        <div className="bg-red-50 border-2 border-red-200 p-3 rounded-lg flex items-start gap-3">
