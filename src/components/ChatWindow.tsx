...
import { getCurrentUserSync } from '../services/auth.ts';
...
export function ChatWindow({ 
  ...
  return (
    <div className="flex flex-col h-full bg-white w-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3 overscroll-contain pb-[170px] md:pb-32 bg-white">
        {messages.length === 0 ? (
      ...
      <div className="fixed bottom-16 md:bottom-12 left-0 right-0 z-30 p-4 border-t border-gray-200 bg-white shadow-[0_-2px_8px_rgba(0,0,0,0.05)]">
        <div className="flex gap-2 max-w-7xl mx-auto">
          <input
            ...
            className="flex-1 px-4 py-3 bg-input border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
            disabled={sending}
            ref={inputRef}
          />
          <button
