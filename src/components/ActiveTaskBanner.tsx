    ...
    <>
      ...
      <div className="sm:hidden fixed bottom-[60px] left-0 right-0 z-40 px-3 pb-2 pointer-events-none">
        <div
          ...
          className="bg-black text-white rounded-full shadow-lg cursor-pointer hover:bg-gray-800 inline-flex items-center gap-2 px-4 py-2.5 ml-auto pointer-events-auto touch-none"
        >
          {imageUrl ? (
          ...
          <span className="text-sm font-semibold">{activeTasksCount} {displayTitle}</span>
        </div>
      </div>
