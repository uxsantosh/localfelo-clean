...
export function TaskCard({ task, onClick, onChatClick }: TaskCardProps) {
  ...
  const getStatusClass = (status: string) => {
    switch (status) {
      case 'negotiating': return 'bg-blue-50 text-blue-700 border border-blue-200';
      case 'open': return 'bg-[#CDFF00] text-black border border-[#CDFF00]';
  ...
  return (
    ...
    >
      ...
      {/* Price/Earnings - FIXED HEIGHT */}
      <div className="mb-3" style={{ height: '32px', display: 'flex', alignItems: 'center' }}>
      ...
      <div className="flex items-center gap-1.5 mb-3" style={{ height: '20px' }}>
