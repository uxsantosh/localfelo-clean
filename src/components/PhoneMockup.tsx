...
export default function PhoneMockup() {
  ...
  return (
    <div 
      className="relative flex justify-center items-center py-6 select-none cursor-grab active:cursor-grabbing group"
    ...
    >
      ...
      >
        ...
        <img
          src="/src/assets/images/hero_phone_mockup_1780478138376.png"
