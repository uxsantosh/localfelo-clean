export default function DownloadCTA() {
  return (
    <section 
      id="download" 
      className="w-full py-12 md:py-24 border-t border-neutral-900 bg-transparent relative z-20 overflow-hidden"
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center space-y-8 relative">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto pt-4" id="download-cta-buttons">
          ...
          <a
            href="#download"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl bg-white text-[#0D0D0D] font-extrabold text-sm hover:bg-neutral-200 transition-colors shadow-2xl shrink-0 text-left font-sans"
          >
          ...
          <a
            href="#download"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl bg-[#161616] border border-neutral-800 text-white font-extrabold text-sm hover:bg-[#202020] hover:border-neutral-700 transition-all shadow-2xl shrink-0 text-left font-sans"
          >
