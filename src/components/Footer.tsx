...
import { FileText, Shield, AlertTriangle, Ban, Mail, Smartphone, Instagram, Facebook, Linkedin } from 'lucide-react';
        ...
        <div className="border-t border-gray-200 pt-3">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-2 text-sm text-muted">
            <div className="flex items-center gap-4">
              ...
              <a href="https://www.instagram.com/localfelo_india/" target="_blank" rel="noopener noreferrer" className="text-body hover:text-primary transition-colors" aria-label="Instagram">
                <Instagram className="w-4 h-4" />
              </a>
              <a href="https://www.facebook.com/profile.php?id=61588207026321" target="_blank" rel="noopener noreferrer" className="text-body hover:text-primary transition-colors" aria-label="Facebook">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="https://www.linkedin.com/company/localfelo/about/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="text-body hover:text-primary transition-colors" aria-label="LinkedIn">
