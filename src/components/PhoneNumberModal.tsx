    ...
    >
      <div className="space-y-5 py-2" style={{ backgroundColor: '#FFFFFF' }}>
        ...
        <div className="text-center">
          <div className="w-16 h-16 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: 'rgba(205, 255, 0, 0.1)' }}>
            <span className="text-4xl">📱</span>
          </div>
          <h3 className="mb-2" style={{ color: '#000000', fontWeight: 700, fontSize: '20px' }}>Add Phone Number</h3>
        ...
        <div className="space-y-3 pt-2">
          ...
          <button
            ...
            className="w-full text-center text-sm hover:text-foreground transition-colors py-2"
            style={{ color: '#666666' }}
          >
            Cancel
          </button>
