...
function AppContent() {
  ...
  console.log('🚨🚨🚨 [App] ABOUT TO CALL usePushNotifications with userId:', user?.id ? user.id.substring(0, 8) + '...' : 'NULL/UNDEFINED');
  const pushStatus = usePushNotifications(user?.id);
  console.log('🚨🚨🚨 [App] usePushNotifications RETURNED:', pushStatus);
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      {['home', 'marketplace', 'wishes', 'tasks', 'helper-tasks', 'chat', 'profile', 'create-wish', 'create-task'].includes(currentScreen) && (
        <BottomNavigation
