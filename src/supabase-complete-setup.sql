-- ========================================
-- OldCycle: COMPLETE LOCATION SETUP (ALL-IN-ONE)
-- ========================================
-- This script combines migration + seed in one file
-- Run this if you want to do everything at once!
-- ========================================

-- =====================================
-- PART 1: MIGRATION (Fix Tables)
-- =====================================

-- Drop existing areas table if it doesn't have city_id
DROP TABLE IF EXISTS areas CASCADE;

-- Create cities table (or use existing)
...
-- Create areas table with proper city_id foreign key
CREATE TABLE areas (
  id TEXT PRIMARY KEY,
...
-- Create RLS policies - Allow everyone to read cities and areas
...
-- =====================================
-- PART 2: SEED DATA (Populate Cities & Areas)
-- =====================================
