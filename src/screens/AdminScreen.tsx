...
import { 
  ...
  AlertTriangle, MessageSquare, Mail, Phone, BarChart3, TrendingUp
} from 'lucide-react';
...
export function AdminScreen({
  ...
  const [activeTab, setActiveTab] = useState<'listings' | 'users' | 'wishes' | 'tasks' | 'reports' | 'site-settings' | 'broadcast' | 'chat-history' | 'all-chats' | 'footer-pages' | 'whatsapp-test' | 'marketplace-intelligence' | 'data-intelligence'>('listings');
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="page-container py-6">
        ...
        {activeTab !== 'site-settings' && activeTab !== 'wishes' && activeTab !== 'tasks' && activeTab !== 'reports' && activeTab !== 'broadcast' && activeTab !== 'chat-history' && activeTab !== 'all-chats' && activeTab !== 'footer-pages' && activeTab !== 'whatsapp-test' && activeTab !== 'marketplace-intelligence' && activeTab !== 'data-intelligence' && (
